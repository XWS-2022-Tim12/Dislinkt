...
values ('629d15e1cdfebd707ce8faec', 'Prvi', 'prvasifra', 'prvi@gmail.com', DATE('2022-03-05'), '0645851733', 'mico', 0, 2);
insert into users (id, first_name, password, email, birth_day, mobile_number, username, gender, role)
...
values ('we78ycq7834qcy3487cyq347', 'First company', 'Address', '061490448', 'Description', '629d15e1cdfebd707ce8faec', true);
insert into companies (id, name, address, phone_number, description, owner_id, approved)
